...
<script>
  ...
  const navigation = {
    ...
    '/modes-and-formats': 'Modes & formats',
    '/autocommit-changes': 'Auto-commit changes',
  ...
  function buildPageNav() {
    const list = document.querySelectorAll('.main-container h2 > a, .main-container h3 > a');
    let newNav = [];
    list.forEach(link => {
      newNav.push({
        // @ts-ignore
        ...
        <ul class="nav">
          ...
          <div class="vp-doc">
            ...
            <div class="nav-footer" style="align-items: flex-start">
              <span>
                <a href="https://github.com/mskocik/svelty-picker"><img src="https://img.shields.io/npm/v/svelty-picker.svg?style=flat" alt="svelty-picker version" class="middle-img"></a>
              </span>
