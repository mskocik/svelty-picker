...
<div class="container !max-w-screen-xl p-3 flex mx-auto justify-between">
  <div class="flex items-center text-4xl font-semibold">
    ...
    <a href="/svelty-picker/" class="decoration-transparent text-3xl lg:text-3">📅 Svelty Picker</a>
  </div>
...
<div class="container !max-w-screen-xl px-3 mx-auto pt-$header-height flex flex-col lg:flex-row">
	<aside class="sidebar z-50 lg:z-0 w-full lg:w-1/5" class:hidden={!navbarShow}>
    <div class="h-full">
      <nav>
