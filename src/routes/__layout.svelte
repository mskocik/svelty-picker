...
<div class="container !max-w-screen-xl p-3 flex mx-auto justify-between">
  <div class="flex items-center text-4xl font-semibold">
    <button class="inline-flex items-center flex-col mr-3 lg:hidden" on:click={() => navToggle = !navToggle}>
    ...
    <a href="{base}/" class="decoration-transparent text-3xl lg:text-3" style="text-decoration: none">📅 Svelty Picker</a>
  </div>
  <div class="flex items-center text-2x">
    <a class="mx-4" href="https://github.com/mskocik/svelty-picker" target="_blank" rel="noreferrer">
...
<div class="container !max-w-screen-xl px-3 mx-auto pt-$header-height flex flex-col lg:flex-row">
        ...
        <ul class="py-4 lg:pt-3">
          <li>
            ...
            <ul class="mb-2 border-l-1 border-gray-300 border-solid">
              ...
              <li>
                <a href={base + '/' + item} class="nav px-4 my-2 decoration-none" class:active={$page.routeId === item}>
                  {pages[item]}
                </a>
              </li>
              {/each}
	...
	<main class="lg:px-6 lg:pt-6 w-full lg:w-4/5">
    <slot />
	</main>
</div>
<div class="py-5">&nbsp;</div>
